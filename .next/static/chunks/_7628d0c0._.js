...
"[project]/src/app/(app)/dashboard/questions/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function QuestionsPage() {
    ...
    const { deleteQuestion, setTests: setLocalTests, tests: localTests } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTestsStore"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "QuestionsPage.useEffect": ()=>{
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isFirebaseEnabled"]) {
                setAllQuestions(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTestsStore"].getState().tests.flatMap({
                    "QuestionsPage.useEffect": (test)=>(test.questions || []).map({
                            "QuestionsPage.useEffect": (q)=>({
                                    ...q,
            ...
            const testsUnsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(testsQuery, {
                "QuestionsPage.useEffect.testsUnsubscribe": (snapshot)=>{
                    const testsData = snapshot.docs.map({
                        "QuestionsPage.useEffect.testsUnsubscribe.testsData": (doc)=>({
                                id: doc.id,
                                ...doc.data()
                            })
                    }["QuestionsPage.useEffect.testsUnsubscribe.testsData"]);
                    setLocalTests(testsData);
                    // Re-map questions with updated test titles if questions are already loaded
                    setAllQuestions({
                        "QuestionsPage.useEffect.testsUnsubscribe": (prevQuestions)=>prevQuestions.map({
                                "QuestionsPage.useEffect.testsUnsubscribe": (q)=>{
                                    const test = testsData.find({
                                        "QuestionsPage.useEffect.testsUnsubscribe.test": (t)=>t.id === q.testId
                                    }["QuestionsPage.useEffect.testsUnsubscribe.test"]);
                                    return {
                                        ...q,
                                        testTitle: test?.title || 'Unknown Test'
                                    };
                                }
                            }["QuestionsPage.useEffect.testsUnsubscribe"])
                    }["QuestionsPage.useEffect.testsUnsubscribe"]);
                }
            }["QuestionsPage.useEffect.testsUnsubscribe"], {
                "QuestionsPage.useEffect.testsUnsubscribe": (error)=>{
            ...
            const questionsUnsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(questionsQuery, {
                "QuestionsPage.useEffect.questionsUnsubscribe": (snapshot)=>{
                    const currentTests = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTestsStore"].getState().tests;
                    const questionsData = snapshot.docs.map({
                        "QuestionsPage.useEffect.questionsUnsubscribe.questionsData": (docSnap)=>{
                            const data = docSnap.data();
                            const testId = docSnap.ref.parent.parent?.id;
                            const test = currentTests.find({
                                "QuestionsPage.useEffect.questionsUnsubscribe.questionsData.test": (t)=>t.id === testId
                            }["QuestionsPage.useEffect.questionsUnsubscribe.questionsData.test"]);
                            return {
                                ...data,
                                id: docSnap.id,
                                testId: testId,
                    ...
                    }["QuestionsPage.useEffect.questionsUnsubscribe.questionsData"]);
                    setAllQuestions(questionsData);
                    setLoading(false);
                }
            }["QuestionsPage.useEffect.questionsUnsubscribe"], {
                "QuestionsPage.useEffect.questionsUnsubscribe": (error)=>{
        ...
        switch(type){
            case 'mcq':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                    ...
                    fileName: "[project]/src/app/(app)/dashboard/questions/page.tsx",
                    lineNumber: 89,
                    columnNumber: 32
                }, this);
            case 'puzzle':
    ...
    const handleDeleteQuestion = (questionId, testId)=>{
        if (!testId) {
            toast({
                variant: 'destructive',
                title: 'Error',
                description: 'Cannot delete question without a test ID.'
            });
            return;
        }
    ...
    const filteredQuestions = allQuestions.filter((question)=>question.questionText?.toLowerCase().includes(searchTerm.toLowerCase()) || question.testTitle?.toLowerCase().includes(searchTerm.toLowerCase()));
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                children: "Manage your reusable questions for all tests."
                            }, void 0, false, {
                                fileName: "[project]/src/app/(app)/dashboard/questions/page.tsx",
                                lineNumber: 120,
                                columnNumber: 13
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableBody"], {
                            children: loading ? Array.from({
                                length: 5
                                    ...
                                    lineNumber: 152,
                                    columnNumber: 19
                                }, this)) : filteredQuestions.length > 0 ? filteredQuestions.map((question)=>{
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                            children: getQuestionTypeBadge(question.type)
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/(app)/dashboard/questions/page.tsx",
                                            lineNumber: 165,
                                            columnNumber: 21
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dropdown$2d$menu$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DropdownMenuContent"], {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dropdown$2d$menu$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DropdownMenuItem"], {
                                                                onClick: ()=>router.push(`/dashboard/tests/${question.testId}`),
                                                                children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dropdown$2d$menu$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DropdownMenuItem"], {
                                                                onClick: ()=>router.push(`/dashboard/questions/${question.id}/edit`),
                                                                children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dropdown$2d$menu$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DropdownMenuItem"], {
                                                                onClick: ()=>handleDeleteQuestion(question.id, question.testId),
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                    ...
                                    children: allQuestions.length > 0 ? 'No questions match your search.' : 'No questions found.'
                                }, void 0, false, {
                                    fileName: "[project]/src/app/(app)/dashboard/questions/page.tsx",
                                    lineNumber: 202,
                                    columnNumber: 21
...
_s(QuestionsPage, "HVj6V1fmH4vfVIF+pZ7hQs3j7wk=", false, function() {
    return [
...
//# sourceMappingURL=_7628d0c0._.js.map