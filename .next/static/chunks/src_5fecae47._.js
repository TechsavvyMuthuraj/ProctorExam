...
function TestPage() {
    ...
    const noFaceTimeoutRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const [fullscreenExits, setFullscreenExits] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TestPage.useEffect": ()=>{
            ...
            const handleFullscreenChange = {
                "TestPage.useEffect.handleFullscreenChange": (event)=>{
                    if (!document.fullscreenElement) {
                        ...
                        if (event.target.activeElement === null || event.target.activeElement === document.body) {
                            ...
                            setFullscreenExits({
                                "TestPage.useEffect.handleFullscreenChange": (prev)=>prev + 1
                ...
                "TestPage.useEffect.checkFace": ()=>{
                    ...
                    if (!isFaceDetected) {
                        if (!noFaceTimeoutRef.current) {
                            ...
                            }["TestPage.useEffect.checkFace"], 3000); // Trigger after 3 seconds of no face
                        }
                    } else {
                        if (noFaceTimeoutRef.current) {
            ...
            const checkMobile = {
                "TestPage.useEffect.checkMobile": ()=>{
            ...
            const proctoringInterval = setInterval({
                "TestPage.useEffect.proctoringInterval": ()=>{
                    checkFace();
                    checkMobile();
                }
            }["TestPage.useEffect.proctoringInterval"], 1000);
...
_s(TestPage, "zrba1mLU3x6kF5OATETh4OCictE=", false, function() {
    return [
...
//# sourceMappingURL=src_5fecae47._.js.map